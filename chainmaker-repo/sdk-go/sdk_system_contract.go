...
func (cc *ChainClient) GetTxByTxId(txId string) (*common.TransactionInfo, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetCommonTransactionByTxId,
		&ArchiveCenterQueryParam{
			TxId: txId,
		}, reflect.TypeOf(ArchiveCenterResponseTransaction{}))
	if httpResp != nil {
		transaction, transactionOk := httpResp.(*common.TransactionInfo)
		// 归档中心查到有效数据
		if transactionOk {
...
func (cc *ChainClient) GetTxWithRWSetByTxId(txId string) (*common.TransactionInfoWithRWSet, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetCommonTransactionWithRWSetByTxId,
		&ArchiveCenterQueryParam{
			TxId: txId,
		}, reflect.TypeOf(ArchiveCenterResponseTransactionWithRwSet{}))
	if httpResp != nil {
		transaction, transactionOk := httpResp.(*common.TransactionInfoWithRWSet)
		// 归档中心查到有效数据
		if transactionOk {
			return transaction, nil
		}
...
func (cc *ChainClient) GetTxByTxIdTruncate(txId string, withRWSet bool, truncateLength int,
	...
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetTruncateTxByTxId,
		&ArchiveCenterQueryParam{
			TxId:           txId,
			WithRwSet:      withRWSet,
	...
	if httpResp != nil {
		tx, txOk := httpResp.(*common.TransactionInfoWithRWSet)
		// 归档中心查到有效数据
		if txOk && tx != nil {
			return tx, nil
		}
...
func (cc *ChainClient) GetBlockByHeight(blockHeight uint64, withRWSet bool) (*common.BlockInfo, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetBlockWithTxRWSetByHeight,
		&ArchiveCenterQueryParam{
			Height: blockHeight,
...
func (cc *ChainClient) GetBlockByHeightTruncate(blockHeight uint64, withRWSet bool, truncateLength int,
	...
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetTruncateBlockByHeight,
		&ArchiveCenterQueryParam{
			Height:         blockHeight,
			WithRwSet:      withRWSet,
			TruncateLength: truncateLength,
...
func (cc *ChainClient) GetBlockByHash(blockHash string, withRWSet bool) (*common.BlockInfo, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetBlockWithTxRWSetByHash,
		&ArchiveCenterQueryParam{
			BlockHash: blockHash,
		}, reflect.TypeOf(ArchiveCenterResponseBlockInfo{}))
	if httpResp != nil {
...
func (cc *ChainClient) GetBlockByTxId(txId string, withRWSet bool) (*common.BlockInfo, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetBlockWithTxRWSetByTxId,
		&ArchiveCenterQueryParam{
			TxId: txId,
		}, reflect.TypeOf(ArchiveCenterResponseBlockInfo{}))
	if httpResp != nil {
...
func (cc *ChainClient) GetFullBlockByHeight(blockHeight uint64) (*store.BlockWithRWSet, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetFullBlockByHeight,
		&ArchiveCenterQueryParam{
			Height: blockHeight,
...
func (cc *ChainClient) getBlockHeight(txId, blockHash string) (uint64, error) {
	if txId != "" {
		// 首先去归档中心查询
		httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetBlockHeightByTxId,
			&ArchiveCenterQueryParam{
				TxId: txId,
			}, reflect.TypeOf(ArchiveCenterResponseHeight{}))
		if httpResp != nil {
			height, heightOk := httpResp.(*uint64)
			if heightOk {
				return *height, nil
			}
		}
		...
		// 首先去归档中心查询
		httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetBlockHeightByHash,
			&ArchiveCenterQueryParam{
				BlockHash: blockHash,
			}, reflect.TypeOf(ArchiveCenterResponseHeight{}))
		if httpResp != nil {
...
func (cc *ChainClient) GetBlockHeaderByHeight(blockHeight uint64) (*common.BlockHeader, error) {
	// 首先去归档中心查询
	httpResp, _ := cc.httpQueryArchiveCenter(archiveCenterApiGetBlockHeaderByHeight,
		&ArchiveCenterQueryParam{
			Height: blockHeight,
		}, reflect.TypeOf(ArchiveCenterResponseBlockHeader{}))
	if httpResp != nil {
		header, headerOk := httpResp.(*common.BlockHeader)
		// 归档中心查到有效数据
		if headerOk {
			return header, nil
		}
