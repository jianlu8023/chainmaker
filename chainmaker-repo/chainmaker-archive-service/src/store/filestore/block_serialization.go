...
// StartEndWrapBlock 区块所在文件信息
type StartEndWrapBlock struct {
	BlockSerializedInfo *BlockWithSerializedInfo
	StartHeight         uint64 // 文件开始高度
	EndHeight           uint64 // 文件结束高度
	NeedRecord          bool   // true 记录到数据库
}
